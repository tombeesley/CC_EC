...
3.88\%. The addition of the interaction term did not improve the model
fit, BF = 0.44 ± 3.95\%, though there was no evidence for the absence of
the interaction. The best fitting model was a better fit than the two
models containing only one of the factors, smallest BF = 36.57 ± 3.89\%,
...
BF\textsubscript{10} = 46.61 ± 1.08\%. The next best fitting model
contained these two factors and the interaction term, and was not a
substantially worse fit to the data, BF = 0.56 ± 1.82\%. The best
...
containing only the factor of configuration BF = 20.7 ± 1.36\% providing
...
1.48\%. The relevant effect sizes (\(n^2_p\)) were: 0.14 for the effect
...
BF\textsubscript{10} = 7.5 × 10\textsuperscript{100} ± 3.98\%. The next
best fitting model contained all three factors and the interaction of
epoch and configuration, BF\textsubscript{10} = 5.2 ×
10\textsuperscript{100} ± 1.28\%, and this model was not a substantially
worse fit to the data, BF = 0.7 ± 4.18\%. All other models were
substantially worse fits than the best fitting model, largest BF = 0.26
± 1.66\%. Importantly, the interaction term between the factors of
...
0.18 ± 4.12\%. The relevant effect sizes (\(n^2_p\)) were: 0.44 for the
...
factors, BF\textsubscript{10} = 9.6 × 10\textsuperscript{14} ± 1.37\%.
There was substantial support for this model over the next best fitting
model, BF = 8.94 ± 2.06\%. To examine the interaction of the
...
3.04\%. The relevant effect sizes (\(n^2_p\)) were: 0.62 for the effect
...
BF\textsubscript{10} = 3.7 × 10\textsuperscript{51} ± 1.95\%. The
...
2.42\%. The relevant effect sizes (\(n^2_p\)) were: 0.77 for the effect
...
10\textsuperscript{24} ± 0.96\%. However, the model without the
interaction provided a strong fit to the data, BF\textsubscript{10} =
5.1 × 10\textsuperscript{24} ± 0.61\%, and a comparison between the two
models did not find any evidence in support of the interaction term, BF
= 0.96 ± 1.14\%. There was strong support for the best fitting model
over the remaining models, smallest BF = 3881.73 ± 1.15\%, providing
...
123.65 ± 1.03\%, providing strong support for the contribution of the
