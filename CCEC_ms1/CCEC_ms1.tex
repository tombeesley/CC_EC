...
4.87\%. The addition of the interaction term did not improve the model
fit, BF = 0.42 ± 5.73\%, though there was no evidence for the absence of
the interaction. The best fitting model was a better fit than the two
models containing only one of the factors, smallest BF = 36.01 ± 5.13\%,
...
BF\textsubscript{10} = 45.79 ± 3.91\%. The next best fitting model
contained these two factors and the interaction term, and was not a
substantially worse fit to the data, BF = 0.61 ± 18.07\%. The best
...
containing only the factor of configuration BF = 21.92 ± 4.33\%
...
2.26 ± 6.8\%. The relevant effect sizes (\(n^2_p\)) were: 0.14 for the
...
BF\textsubscript{10} = 7.3 × 10\textsuperscript{100} ± 8.49\%. The next
best fitting model contained all three factors and the interaction of
epoch and configuration, BF\textsubscript{10} = 4.5 ×
10\textsuperscript{100} ± 4.32\%, and this model was not a substantially
worse fit to the data, BF = 0.61 ± 9.53\%. All other models were
substantially worse fits than the best fitting model, largest BF = 0.27
± 6.13\%. Importantly, the interaction term between the factors of
...
0.17 ± 9.54\%. The relevant effect sizes (\(n^2_p\)) were: 0.02 for the
...
interaction between the factors, BF\textsubscript{10} = 9.7 ×
10\textsuperscript{14} ± 4.37\%. There was substantial support for this
model over the next best fitting model, BF = 10.32 ± 5.65\%. To examine
...
interaction, BF = 0.16 ± 11.71\%. The relevant effect sizes (\(n^2_p\))
...
BF\textsubscript{10} = 3.4 × 10\textsuperscript{51} ± 4.2\%. The
...
12.92\%. The relevant effect sizes (\(n^2_p\)) were: 0.77 for the effect
...
10\textsuperscript{24} ± 3.71\%. However, the model without the
interaction provided a strong fit to the data, BF\textsubscript{10} = 5
× 10\textsuperscript{24} ± 3.46\%, and a comparison between the two
models did not find any evidence in support of the interaction term, BF
= 0.93 ± 5.07\%. There was strong support for the best fitting model
over the remaining models, smallest BF = 3962.09 ± 4.01\%, providing
...
BF\textsubscript{10} = 1.4 × 10\textsuperscript{14} ± 3.24\%. This model
...
119.54 ± 4.62\%, providing strong support for the contribution of the
