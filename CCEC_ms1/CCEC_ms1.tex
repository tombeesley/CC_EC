...
configuration (repeated vs.~random), BF\textsubscript{10} = 1.9 ×
10\textsuperscript{12} ± 7.11\%. The addition of the interaction term
did not improve the model fit, BF = 0.56 ± 18.36\%, though there was no
...
smallest BF = 29.22 ± 15.48\%, providing strong support for both the
...
BF\textsubscript{10} = 35.58 ± 9.28\%. The next best fitting model
contained these two factors and the interaction term, and was not a
substantially worse fit to the data, BF = 1.01 ± 34.06\%. The best
...
containing only the factor of configuration BF = 12.99 ± 24.11\%
...
1.74 ± 11.71\%. The relevant effect sizes (\(n^2_p\)) were: 0.14 for the
...
BF\textsubscript{10} = 8.1 × 10\textsuperscript{100} ± 19.32\%. The next
best fitting model contained all three factors and the interaction of
epoch and configuration, BF\textsubscript{10} = 3.9 ×
10\textsuperscript{100} ± 8.78\%, and this model was not a substantially
worse fit to the data, BF = 0.49 ± 21.22\%. All other models were
substantially worse fits than the best fitting model, largest BF = 0.4 ±
28.45\%. Importantly, the interaction term between the factors of
...
0.2 ± 33.25\%. The relevant effect sizes (\(n^2_p\)) were: 0.02 for the
...
interaction between the factors, BF\textsubscript{10} = 7.9 ×
10\textsuperscript{14} ± 6.31\%. There was substantial support for this
model over the next best fitting model, BF = 8.43 ± 11.81\%. To examine
...
interaction, BF = 0.09 ± 14.83\%. The relevant effect sizes (\(n^2_p\))
...
BF\textsubscript{10} = 2.7 × 10\textsuperscript{51} ± 7.26\%. The
...
11.8\%. The relevant effect sizes (\(n^2_p\)) were: 0.77 for the effect
...
between those factors, BF\textsubscript{10} = 5.6 ×
10\textsuperscript{24} ± 13.35\%. However, the model without the
interaction provided a strong fit to the data, BF\textsubscript{10} =
4.7 × 10\textsuperscript{24} ± 9.9\%, and a comparison between the two
models did not find any evidence in support of the interaction term, BF
= 0.85 ± 16.62\%. There was strong support for the best fitting model
over the remaining models, smallest BF = 4235.38 ± 14.21\%, providing
...
BF\textsubscript{10} = 1.3 × 10\textsuperscript{14} ± 7.95\%. This model
...
112.06 ± 9.59\%, providing strong support for the contribution of the
