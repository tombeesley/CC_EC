...
configuration (repeated vs.~random), BF\textsubscript{10} = 2.9 ×
10\textsuperscript{12} ± 20.03\%. The addition of the interaction term
did not improve the model fit, BF = 0.3 ± 21.99\%, though there was no
...
smallest BF = 46.21 ± 20.64\%, providing strong support for both the
...
BF\textsubscript{10} = 39.7 ± 8.14\%. The next best fitting model
contained these two factors and the interaction term, and was not a
substantially worse fit to the data, BF = 0.59 ± 17.87\%. The best
...
containing only the factor of configuration BF = 14.16 ± 29.68\%
...
1.75 ± 14.45\%. The relevant effect sizes (\(n^2_p\)) were: 0.1394981
...
BF\textsubscript{10} = 7.5 × 10\textsuperscript{100} ± 19.75\%. The next
best fitting model contained all three factors and the interaction of
epoch and configuration, BF\textsubscript{10} = 3.8 ×
10\textsuperscript{100} ± 6.81\%, and this model was not a substantially
worse fit to the data, BF = 0.51 ± 20.89\%. All other models were
substantially worse fits than the best fitting model, largest BF = 1.86
± 86.24\%. Importantly, the interaction term between the factors of
...
0.94 ± 88.22\%. The relevant effect sizes (\(n^2_p\)) were: 0.018597 for
...
interaction between the factors, BF\textsubscript{10} = 1.3 ×
10\textsuperscript{15} ± 32.91\%. There was substantial support for this
model over the next best fitting model, BF = 14.4 ± 33.61\%. To examine
...
interaction, BF = 0.1 ± 15.45\%. The relevant effect sizes (\(n^2_p\))
...
BF\textsubscript{10} = 3.3 × 10\textsuperscript{51} ± 10.21\%. The
...
15.07\%. The relevant effect sizes (\(n^2_p\)) were: 0.7699908 for the
...
10\textsuperscript{24} ± 15.57\%. However, the model without the
interaction provided a strong fit to the data, BF\textsubscript{10} =
5.4 × 10\textsuperscript{24} ± 16.62\%, and a comparison between the two
models did not find any evidence in support of the interaction term, BF
= 1 ± 22.77\%. There was strong support for the best fitting model over
the remaining models, smallest BF = 4215.91 ± 15.83\%, providing strong
support for the factors of epoch and configuration. The relevant effect
sizes (\(n^2_p\)) were: 0.3790593 for the effect of the endogenous cue;
and 0.4687663 for the effect of configuration; and 0.0805809 for the
...
BF\textsubscript{10} = 1.6 × 10\textsuperscript{14} ± 11.44\%. This
...
= 25.61 ± 76.51\%, providing strong support for the contribution of the
