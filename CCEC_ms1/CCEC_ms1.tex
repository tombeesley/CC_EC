...
sample (\citeproc{ref-cousineau2005}{\textbf{cousineau2005?}}).}
...
some findings in the CC literature (i.e., \citeproc{ref-endo2004}{Endo
\& Takeda, 2004}; \citeproc{ref-kunar2014}{Kunar et al., 2014}), where
...
process (e.g., \citeproc{ref-beesley2012}{Beesley \& Shanks, 2012}).
...
(\citeproc{ref-beesley2018}{Beesley et al., 2018};
...
an automatic influence on behaviour (\citeproc{ref-chun2000a}{Chun,
2000}; e.g., \citeproc{ref-chun1998}{Chun \& Jiang, 1998};
...
(\citeproc{ref-luque2017b}{Luque et al., 2017};
...
(\citeproc{ref-moors2006}{Moors \& De Houwer, 2006}). Such a test was
...
visual search (\citeproc{ref-sewell2018}{Sewell et al., 2018}). Notably,
