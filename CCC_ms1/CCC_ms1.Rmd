...
# computing effect sizes
e2_phase1_ES <- effectsize::eta_squared(aov_car(meanRT ~ Error(subj/config*targ_pos*epoch), 
                                                data = phase_2), 
                                        partial = TRUE,
