...
To provide further support for the absence of the interaction between the factors of configuration type and endogenous cue, the data from across the experiment (epochs 1-10) were analysed with a Bayesian ANOVA with only the factors of configuration and endogenous cue. The best fitting model was that with the two factors and no interaction, `r report_BF_and_error(all_exp2_BF[3])`. The addition of the interaction term did not strengthen the model, providing substantial evidence for the absence of the interaction, `r report_BF_and_error(all_exp2_BF[4]/all_exp2_BF[3], sci_not = FALSE, hyp = "mc")`.
...
phase_2_avg_RT <- 
  phase_2_TT_e3 %>%
  mutate(TT = fct_relevel(TT, "Repeated", "Rep. PROXIMAL",
                          "Rep. DISTAL", "Random")) %>% 
...
```{r Exp3-Phase-2-figure, fig.align="center", fig.cap="(ref:Exp3-Phase-2-figure)", fig.dim=c(5,4), include=FALSE}

# THIS PLOT IS NO LONGER PRESENTED
...
```{r Exp3-Phase-2-RTdiff-figure, fig.align="center", fig.cap="(ref:Exp3-Phase-2-RTdiff-figure)", fig.dim=c(5,4), include=FALSE}

# THIS FIGURE IS NO LONGER PRESENTED
