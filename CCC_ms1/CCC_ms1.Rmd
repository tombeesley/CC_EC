...
phase_1_BF_simple <- 
  anovaBF(meanRT ~ patArrowP1*TT + subj,
          data= data.frame(phase_1),
          whichRandom = "subj", iterations = 100000)


int_effect <- phase_1_BF_simple[4]/phase_1_BF_simple[3]
