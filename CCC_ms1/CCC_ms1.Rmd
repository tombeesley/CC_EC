...
A Bayesian ANOVA on the data from phase 2 (epochs 6-10) found significant support for the model containing the factor of configuration, `r report_BF_and_error(e1_phase2_BF[2])`. There was evidence to suggest that the addition of the factor of epoch did not substantially improve the model predictions, `r report_BF_and_error(e1_phase2_BF[3]/e1_phase2_BF[2], sci_not = FALSE)`. Comparing the response times from just "repeated: consistent" trials with their respective random trials (random: consistent), revealed support for a difference between these trial types, `r report_BF_and_error(CvR_BF, sci_not = FALSE)`. There was no evidence to support a difference between the "repeated: inconsistent" trials and the respective random trials, `r report_BF_and_error(IvR_BF, sci_not = FALSE)`. There was substantial support for a difference between the repeated consistent and the repeated inconsistent trials, `r report_BF_and_error(CvI_BF, sci_not = FALSE)`.
...
#                    "Repeated LOCAL"))
# 
# d1v3_BF <- anovaBF(meanRT ~ TT + subj,
#                    whichRandom = "subj",
#                    data = d1v3)
# 
...
#                    "Repeated GLOBAL"))
# 
# d1v4_BF <- anovaBF(meanRT ~ TT + subj,
#                    whichRandom = "subj",
#                    data = d1v4)
# 
# # local vs. random
...
#                    "Repeated LOCAL"))
# 
# d2v3_BF <- anovaBF(meanRT ~ TT + subj,
#                    whichRandom = "subj",
#                    data = d2v3)
# 
# # global vs. random
...
#                    "Repeated GLOBAL"))
# 
# d2v4_BF <- anovaBF(meanRT ~ TT + subj,
#                    whichRandom = "subj",
#                    data = d2v4)
# 
# # local  vs. global  
...
#                    "Repeated GLOBAL"))
# 
# d3v4_BF <- anovaBF(meanRT ~ TT + subj,
#                    whichRandom = "subj",
#                    data = d3v4)
