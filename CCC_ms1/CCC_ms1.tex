...
\urlstyle{same}
\hypersetup{
  pdftitle={Contextual cuing in the presence of an endgenous cue for attention},
...
\title{Contextual cuing in the presence of an endgenous cue for attention}
